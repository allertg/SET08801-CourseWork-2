// Select all required elements from the HTML document
...
window.onload = () => {
    ...
    allBox.forEach(box => {
        box.addEventListener("click", () => clickedBox(box)); // Call clickedBox function when a box is clicked
    });
};
...
function clickedBox(element) {
    //Determine which player's turn it is and update the box accordingly
    //The next line also checks that the player has not already selected a box, preventing overwriting
